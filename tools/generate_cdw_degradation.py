...
def simulate_cdw_module(module_id, base_damage_rate, initial_fn, initial_k_term,
                        critical_fn, critical_k_term, months_max=120,
                        samples_per_month=30):
    """
    Simulate the life of a C&DW housing module.
...
def generate_dataset(num_modules, output_path):
    ...
    print(f"[CDW-DEGRADATION] SSOT loaded:")
    ...
    print(f"\n[CDW-DEGRADATION] Dataset complete.")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="C&DW Degradation Emulator (LSTM Training Data)")
